...
def generateWageReport(target_state, target_county, target_city, target_industry, 
    ...
    url1 = "https://enfxfr.dol.gov/data_catalog/WHD/whd_whisard_20230407.csv.zip" #update link from here https://enforcedata.dol.gov/views/data_catalogs.php
...
def Industry_Summary_Block(out_counts, df, total_ee_violtd, total_bw_atp, total_case_violtn, unique_legalname, agency_df, OPEN_CASES, textFile):
    ...
    if OPEN_CASES == 1:
        textFile.write(
            "<p>This report has cases removed that are documented as paid or claimant withdrew or the amount repaid matches the backwages owe.</p> \n")
