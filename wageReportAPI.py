...
def generateFile():
    ...
    SANTA_CLARA_COUNTY_ZIPCODE = ['Santa Clara County'] + Santa_Clara_Unincorporated_Zipcode + Cupertino_City_Zipcode 
    ...
    PARAM_2_TARGET_INDUSTRY = ALL_NAICS_LIBRARY() #<-- #COPY and PASTE FROM wagetheft_report_2020_v2
    ...
    SIGNATORY_INDUSTRY = Signatory_Library() #<-- #COPY and PASTE FROM wagetheft_report_2020_v2
